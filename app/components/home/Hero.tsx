...
const Hero = () => {
  return (
    <section className="mx-auto max-w-7xl px-6 py-16 md:py-24 lg:px-32 lg:pb-20 flex items-center">
      <div className="flex flex-col items-center md:items-start space-y-8 max-w-4xl w-full text-center md:text-left">
        ...
        <div className="space-y-3 max-w-2xl">
          ...
          <p className="text-lg text-white leading-relaxed drop-shadow-lg">
            Let us guide you to the perfect home that matches your lifestyle and
            aspirations.
          </p>
        </div>
